...
insert into customer values ('Oliver',  'First Street', 'Oporto');
insert into customer values ('Parker',  'Liberty Avenue',  'Lisbon');

-- Populate Branches
insert into branch values ('Downtown',  'Lisbon',   1900000);
insert into branch values ('Central', 'Cascais',    2100000);
insert into branch values ('Uptown',  'Lisbon',   1700000);
insert into branch values ('Metro',   'Amadora',    0400200);
insert into branch values ('Round Hill', 'Amadora',   8000000);
insert into branch values ('Ship Terminal', 'Oporto', 0400000);
